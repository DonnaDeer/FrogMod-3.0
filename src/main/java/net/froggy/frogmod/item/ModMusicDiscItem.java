...
class ModMusicDiscItem extends Item {
    private static final Map<SoundEvent, ModMusicDiscItem> MUSIC_DISCS = Maps.newHashMap();
    private final int comparatorOutput;
    private final SoundEvent sound;

    protected ModMusicDiscItem(int comparatorOutput, SoundEvent sound, Settings settings) {
        super(settings);
    ...
    @Nullable
    public static ModMusicDiscItem bySound(SoundEvent sound) {
        return (ModMusicDiscItem)MUSIC_DISCS.get(sound);
    }
