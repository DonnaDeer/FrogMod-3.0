package net.froggy.frogmod.entity;
...
public class AmethystArrowEntity extends PersistentProjectileEntity {
    ...
    public void initFromStack(ItemStack stack) {
        ...
        } else if (stack.isOf(ModItems.AMETHYST_ARROW)) {
            this.potion = Potions.EMPTY;
            this.effects.clear();
    ...
    static {
        COLOR = DataTracker.registerData(AmethystArrowEntity.class, TrackedDataHandlerRegistry.INTEGER);
    }
}
